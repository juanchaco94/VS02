...
namespace VS02.Controllers
{
    public class SpecialtiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdSpecialty,name")] Specialty specialty)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdSpecialty,name")] Specialty specialty)
        {
            if (ModelState.IsValid)
            {
